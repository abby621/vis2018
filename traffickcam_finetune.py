...
# chop off last layer: python traffickcam_finetune.py .3 120 128 .0001 3 True './models/ilsvrc.ckpt'
# don't chop off last layer: python traffickcam_finetune.py .3 120 128 .0001 3 False './models/ilsvrc.ckpt'
"""
