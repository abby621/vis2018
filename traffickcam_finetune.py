# -*- coding: utf-8 -*-
"""
# python traffickcam_finetune.py margin batch_size output_size learning_rate whichGPU is_finetuning pretrained_net
# chop off last layer: python traffickcam_finetune.py .3 120 128 .0001 3 True './models/ilsvrc/resnet_v2_50.ckpt'
# don't chop off last layer: python traffickcam_finetune.py .3 120 128 .0001 3 False './models/ilsvrc/resnet_v2_50.ckpt'
"""
